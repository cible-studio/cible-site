...
<section class="hero-wrap">
    ...
    <div class="hero">
        <div>
            ...
            <div class="actions">
                <a class="bouton b-rouge" href="{{ route('contact') }}">Rendre ma marque visible<svg class="fl" viewBox="0 0 177 119"><use href="#fh-droite-mini"/></svg></a>
...
<div class="ticker" aria-hidden="true" style="margin-top:clamp(24px,4vw,44px)">
    ...
    <div class="piste">
        <b style="background:var(--rouge)" class="num">+ 400 panneaux</b>
...
<section class="travaux" id="travaux">
    ...
    <div class="travaux-tete rev">
        ...
        <a class="bouton b-ligne" href="{{ route('references') }}">Voir toutes les réalisations<svg class="fl" viewBox="0 0 177 119"><use href="#fh-droite-mini"/></svg></a>
    </div>
...
<section class="reseau" id="reseau">
    ...
    <div class="reseau-grille">
        <div class="rev">
            ...
            <a class="bouton b-blanc" style="margin-top:34px" href="{{ route('reseau') }}">Explorer la carte du réseau<svg class="fl" viewBox="0 0 177 119"><use href="#fh-droite-mini"/></svg></a>
        </div>
        <div class="rev">
...
<section class="contact-home" id="contact">
    ...
    <div class="contact-inner rev">
        ...
        <a class="bouton b-rouge" style="margin-top:28px" href="{{ route('contact') }}">Recevoir une recommandation média<svg class="fl" viewBox="0 0 177 119"><use href="#fh-droite-mini"/></svg></a>
        <div class="coord">
